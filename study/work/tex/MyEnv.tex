...
\usepackage{qcircuit} % 量子回路 % qiskitはこれを使っている
% \usetikzlibrary{quantikz} % qcircuitと衝突
\usepackage[square,sort,comma,numbers]{natbib}

\usetikzlibrary{arrows.meta}
\usetikzlibrary{angles,quotes}

\newenvironment{Axiom}{\begin{screen}\begin{axiom}}{\end{axiom}\end{screen}}
...
\newenvironment{Mondai}{\begin{screen}\begin{mondai}}{\end{mondai}\end{screen}}
\newenvironment{Meidai}{\begin{screen}\begin{meidai}}{\end{meidai}\end{screen}}
...
\newcommand{\Tr}[1]{\text{Tr}\,(#1)} % トレース
\newcommand{\spn}{\text{span}} % span
\newcommand{\SU}{\text{SU}} % 特殊ユニタリ群
% \newcommand{\Pr}{\text{Pr}} % 確率 % already exists
\newcommand{\E}{\text{E}} % 期待値
\newcommand{\V}{\text{V}} % 分散
